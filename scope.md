...
Переменные в JS могут быть глобальными (доступна везде) и локальными (видны только в текущей области видимости).
...
Локальная область видимости ограничивается функцией или блоком (`{...}`):
